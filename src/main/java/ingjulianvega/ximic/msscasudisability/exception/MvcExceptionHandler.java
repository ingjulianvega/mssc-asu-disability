...
import ingjulianvega.ximic.msscasudisability.configuration.DisabilityParameters;
...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(DisabilityParameters disabilityParameters) {
        this.disabilityParameters = disabilityParameters;
    }

    DisabilityParameters disabilityParameters;


    @ExceptionHandler(DisabilityException.class)
    public ResponseEntity<ApiError> validationErrorHandler(DisabilityException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(disabilityParameters.getApi())
